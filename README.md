# mav_tools
This repository is the catkinized version of some of the packages included in mav_tools: [https://github.com/ccny-ros-pkg/mav_tools](https://github.com/ccny-ros-pkg/mav_tools).
...
This repository is formed by a two packages: 
